...
What if you just want to be able to set something outside of your applications models? Maybe you'd like to be able to configure something like the text fields on your login page?
