...
Sometimes you just want to be able to have a set something outside of your applications models. Maybe you want to be able to configure something like the text fields on your login page.
